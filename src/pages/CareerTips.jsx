...
const CareerTips = () => {
    ...
    const tips = [
        ...
        },
        {
            ...
            icon: DollarSign, // Using generic icon logic below if DollarSign not imported, will use Sparkles as fallback logic if needed but icon set here
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[calc(100vh-8rem)]">
                    ...
                    <div className="lg:col-span-1 space-y-6 overflow-y-auto pr-2 custom-scrollbar">
                        <div className="bg-gradient-to-r from-[#4169E1] to-[#3A5FCD] p-6 rounded-2xl text-white shadow-lg">
                            ...
                            <p className="text-blue-100 opacity-90">Expert advice to help you land your dream job.</p>
                        </div>
                        ...
                        {tips.map((tip, index) => (
                            <div key={index} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                                <div className="flex items-center mb-4">
                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${tip.color} mr-4 group-hover:scale-110 transition-transform`}>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
                            ...
                            <p className="text-gray-500 text-sm">Take 5 minutes to relax. A fresh mind performs better!</p>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 flex flex-col bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden relative">
                        ...
                        <div className="bg-white border-b border-gray-100 p-4 flex justify-between items-center sticky top-0 z-10">
                            ...
                            <div className={`px-4 py-1.5 rounded-full text-xs font-bold border ${
                                ...
                                {remainingChats}/10 Chats Left Today
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50/50 scroll-smooth" ref={chatContainerRef}>
                            {messages.map((msg) => (
                                ...
                                >
                                    ...
                                    >
                                        {msg.sender === 'ai' && (
                                            <div className="flex items-center mb-1 text-xs font-bold text-[#4169E1] uppercase tracking-wide opacity-80">
                                                AI Coach
                                            </div>
                                        )}
                        ...
                        <div className="p-4 bg-white border-t border-gray-100">
                            ...
                            <form onSubmit={handleSend} className="relative">
                                <input 
                                    ...
                                    className="w-full pl-5 pr-14 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4169E1]/50 focus:border-[#4169E1] transition-all disabled:opacity-60 disabled:cursor-not-allowed placeholder-gray-400 text-gray-700 font-medium shadow-inner"
                                />
                                <button 
                                    type="submit" 
